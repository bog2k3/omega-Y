...
// Return the total time of the current node
inline double ProfileNodeIterator::getCurrentTotalTime() {
...
// Return the total time of the current parent node
inline double ProfileNodeIterator::getCurrentParentTotalTime() {
...
// Return the total time spent in the block of code
inline double ProfileNode::getTotalTime() const {
    return mTotalTime;
}
...
// Return the elasped time since the start/reset of the profiling
inline double Profiler::getElapsedTimeSinceStart() {
    double currentTime = Timer::getCurrentSystemTime() * 1000.0L;
